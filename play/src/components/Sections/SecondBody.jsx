  ...
  return (
    <div className="flex justify-center relative bg-background text-text">
      <div className="w-full flex justify-center">
        <div className="w-9/12 flex flex-col gap-8 sm:flex-row text-center lg:text-start justify-center items-center pt-14 mb-20">
          <div className="w-full sm:w-1/2 flex flex-col gap-y-2 lg:gap-y-4">
            ...
            <button className="z-30 my-2 text-2xl lg:text-3xl p-3 border-4 border-secondary text-secondary shadow-xl rounded-lg transition-transform duration-700 hover:border-secondaryLight hover:text-secondaryLight hover:scale-105 active:scale-95">
              Explore Games
            </button>
          </div>

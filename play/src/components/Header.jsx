  ...
  return (
    <div className="flex justify-center ">
      <div className="w-full fixed flex justify-center">
        <div className="w-9/12 justify-center flex flex-col sm:flex-row gap-24 sm:gap-0 items-center mt-20">
          ...
          <div className="w-full sm:w-1/2 flex flex-col justify-center gap-y-6 sm:gap-y-12 items-center text-center font-semibold relative">
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-8xl relative z-10 font-bold">
            ...
            <div className="flex items-center gap-8 sm:gap-6 md:gap-10 lg:gap-14">
              <div className="relative group flex">
                ...
                <div className="bg-secondaryLight w-full h-full absolute top-0 blur-2xl"></div>
              </div>

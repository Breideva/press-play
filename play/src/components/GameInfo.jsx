export default function GameInfo({ title, items, span, size, color,padding }) {
  return (
    ...
    >
      <h3 className="text-2xl sm:text-3xl md:text-3xl lg:text-xl xl:text-3xl pb-4 text-secondary font-semibold">{title}</h3>
      <div className="flex flex-wrap justify-center">
        {items ? (
          <div className="flex" style={{fontSize: `${size}px`, color: `${color}`}}>

  ...
  return (
    <div className="w-9/12 flex justify-center items-center">
      ...
      >
        ...
        />
        <input
          className="pl-2 w-full h-full text-text outline-none font-thin text-lg sm:text-xl placeholder-text rounded-xl transition-all bg-transparent duration-500 bg-opacity-0 group-bg-text group-focus-within:bg-opacity-100 group-focus-within:text-background group-focus-within:placeholder-background"
